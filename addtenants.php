...
if(isset($_GET['occupied']) && $_GET['occupied'] == 'true') {
        ...
        <div class="navbar-nav w-100">
            ...
            <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu bg-transparent border-0 rounded-0 rounded-bottom m-0">
                    <a href="addtenants.php" class="dropdown-item active">Add Tenants</a>
...
<div class="content">
  <nav class="navbar navbar-expand bg-secondary navbar-dark sticky-top px-4 py-0">
    ...
    <div class="col-sm-12 col-xl-6 container" style="width: 100%; margin-top: 30px; ">
    <div class="row w-100 h-100 justify-content-center d-flex">
        <div class="bg-secondary rounded h-90 p-4 m-3 col-12 col-md-6" style=" width: 60%">
            <h5 class="mb-4">Add Tenants</h5>
            <form id="tenantForm" action="process.php" method="post">
                <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="floatingInput" placeholder="lastname" name="lname" required >
                    <label for="floatingInput">Last Name</label>
                </div>
                <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="floatingPassword" placeholder="firstname" name="fname" required>
                    <label for="floatingPassword">First Name</label>
                </div>
            <div class="form-floating mb-3" style="margin-bottom: 1rem;">
            ...
            <div class="form-floating mb-3" style="margin-bottom: 1rem;">
                <input type="text" class="form-control" id="floatingPassword"
                    placeholder="firstname"name="gender"required>
            ...
            <div class="form-floating mb-3" style="margin-bottom: 1rem;">
                <input type="text" class="form-control" id="floatingPassword"
                    placeholder="contactnum"name="contact"required>
                <label for="floatingPassword">Contact Number</label>
            </div>
        <div class="form-floating mb-3" style="margin-bottom: 1rem;">
            <input type="text" class="form-control" id="floatingPassword"
                placeholder="roomnum"name="roomnum" required>
            <label for="floatingPassword">Room Number</label>
        </div>
        <div class="form-floating mb-3" style="margin-bottom: 1rem;">
            <input type="text" class="form-control" id="floatingPassword"
                placeholder="deposit"name="deposit" required>
            <label for="floatingPassword">Deposit</label>
        </div>
        <div class="form-floating mb-3" style="margin-bottom: 1rem;">
            <input type="text" class="form-control" id="floatingPassword"
                placeholder="roomprice"name="roomprice" required>
        ...
        <div class="form-floating mb-3" style="margin-bottom: 1rem;">
            ...
            <label for="floatingPassword">Date Occupied</label>
        </div>
