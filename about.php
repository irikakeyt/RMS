...
<div class="sidebar pe-4 pb-3">
    <nav class="navbar bg-secondary navbar-dark">
        ...
        <div class="navbar-nav w-100">
            ...
            <a href="about.php" class="nav-item nav-link active"><i class="fas fa-info-circle me-2"></i>About Us</a>
        </div>
    </nav>
</div>
...
<div class="container-fluid py-4">
    <div class="row">
        <div class="col-lg-6 mx-auto text-center">
            ...
            <p class="text-muted">Our company, VECTO. The name VECTO  is derived from our first names, Valerie, Ericka, Chery and Clave, Therence and Osmhar. We are a company that specializes in room management system. Deriving the logo from the names of the founders symbolizes the collective effort and collaboration that led to the establishment of VECTO.</p>
        </div>
    </div>
    <div class="row mt-4">
        <div class="col-lg-2 col-md-4 col-sm-6 mx-auto">
            <div class="team-member text-center">
            <img src="img/bariri.jpg" class="img-fluid rounded-circle mb-3" alt="Team Member" style="width: 200px; height: 200px;">
                <h4>Valerie M. <br>Martinez</h4>
                <p class="text-muted">Software Engineer</p>
            </div>
        </div>
        <div class="col-lg-2 col-md-4 col-sm-6 mx-auto">
            <div class="team-member text-center">
                <img src="img/kit.jpg" class="img-fluid rounded-circle mb-3" alt="Team Member" style="width: 200px; height: 200px;">
                <h4>Ericka Kate V. Gregorio</h4>
                <p class="text-muted">UI Designer</p>
            </div>
        </div>
        <div class="col-lg-2 col-md-4 col-sm-6 mx-auto">
            <div class="team-member text-center">
                <img src="img/lunox.jpg" class="img-fluid rounded-circle mb-3" alt="Team Member" style="width: 200px; height: 200px;">
                <h4>Osmhar Lenoux S. Solilap</h4>
                <p class="text-muted">Project Manager</p>
            </div>
        </div>
        <div class="col-lg-2 col-md-4 col-sm-6 mx-auto">
            <div class="team-member text-center">
                <img src="img/misay.jpg" class="img-fluid rounded-circle mb-3" alt="Team Member" style="width: 200px; height: 200px;">
                <h4>Chery Nicole G. Pastilloso</h4>
                <p class="text-muted">Documentator</p>
            </div>
        </div>
        <div class="col-lg-2 col-md-4 col-sm-6 mx-auto">
            <div class="team-member text-center">
                <img src="img/clave.jpg" class="img-fluid rounded-circle mb-3" alt="Team Member" style="width: 200px; height: 200px;">
                <h4>Clave Anthony D. Lasconia</h4>
                <p class="text-muted">Graphic Designer</p>
            </div>
        </div>
        <div class="col-lg-2 col-md-4 col-sm-6 mx-auto">
            <div class="team-member text-center">
                <img src="img/hilcee.jpg" class="img-fluid rounded-circle mb-3" alt="Team Member" style="width: 200px; height: 200px;">
                <h4>Therence Hilcee R. Defante</h4>
